 ...
 *
 * NOTE: All Kimi variants (incl. 'moonshotai/kimi-k3' and 'moonshotai/kimi-k2.7-code', which
 * reason by default) need the extended timeout — but their model IDs don't contain 'thinking',
